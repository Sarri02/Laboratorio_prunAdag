...
* **Analisi Comparativa:** Confronta le prestazioni della rete addestrata tramite PruneAdag con quelle della rete ottenuta utilizzando l'ottimizzatore Adam, come segue:
    * Verifica se PruneAdag è in grado di addestrare correttamente la rete, accertandoti che la perdita sia effettivamente ridotta e che la qualità dell'adattamento sia paragonabile a quella della rete addestrata con Adam.
    * Mostra il grafico della diminuzione della perdita nel corso delle epoche, per ciascun problema e per entrambi gli algoritmi.
    * Confronta le prestazioni di test (in termini di accuratezza di test) dei due modelli.
